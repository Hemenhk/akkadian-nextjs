            ...
            <div className="flex flex-col gap-2 ml-1 mt-2">
              ...
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-1">
                  ...
                  />
                  -
                  <p className="text-sm font-normal">{reviewData[0]?.author}</p>
                  {reviewData[0]?.isVerified ? (
                    <p className="flex items-center rounded-[2px] bg-black text-white text-xs tracking-wider mr-3 py-[2px] px-3">
                      Verified
                    </p>
                  ) : (
                    ""
